...
with st.form('user inputs'):
    ...
    sex = st.selectbox('Sex', options = ['Femele','Male'])
...
st.write('the user input are {}'.format(
    [island,sex,bill_length,bill_depth,flipper_length,body_mass]
))

st.write('We used a machine learning (Random Forest) model to predict',
'the species, the features used in this prediction are ranked by relative importance below.')

st.image('feature_importance.png')

st.write('Below are the histograms for each continuous variable'
'seperated by penguin species. The vertical line '
